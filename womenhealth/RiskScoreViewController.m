...
- (void)viewDidLoad
{
    ...
    [super viewDidLoad];
    [[ResultManager sharedInstance]saveResultWithValue:theDataObject.riskLevel withKey:@"Risk Assessment Result"];
    [[ResultManager sharedInstance]saveResultWithValue: [NSString stringWithFormat:@"%d",theDataObject.riskScore] withKey:@"Risk Assessment Score"];
    [[ResultManager sharedInstance]showResult];
