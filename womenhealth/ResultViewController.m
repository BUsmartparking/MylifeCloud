...
- (void)viewDidLoad
{
    ...
    [[ResultManager sharedInstance]saveResultWithValue:theDataObject.result withKey:@"Final Result: "];
...
- (IBAction)submitButton:(id)sender {
    ...
    [currentDateTime timeIntervalSince1970];
    ...
    if(!theDataObject.resultSubmitted){
        ...
        [[ResultManager sharedInstance]upload:dateInStringFormated];
        UIAlertView *alert = [[UIAlertView alloc]
                              initWithTitle: @""
