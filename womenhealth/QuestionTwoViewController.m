...
- (IBAction)pressYes:(id)sender {
  ...
  /*  if (theDataObject.supportCount<9) {
    ...
    [[ResultManager sharedInstance]saveResultWithValue:title withKey:[NSString stringWithFormat:@"Question Two: %d", theDataObject.supportCount]];
...
- (IBAction)nextQuestionButton:(id)sender {
    ...
    if(theDataObject.supportCount == 2 && [self.textField.text length] ==0){
        ...
        [[ResultManager sharedInstance]saveResultWithValue:self.textField.text withKey:[NSString stringWithFormat:@"Question Two: %d", theDataObject.supportCount]];
